...
Func ApplyConfig_600_18($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_hChkNotifyAlertProfileSwitch, $g_bNotifyAlertProfileSwitch ? $GUI_CHECKED : $GUI_UNCHECKED)
		...
		Case "Save"
			...
			$g_bNotifyAlertProfileSwitch = (GUICtrlRead($g_hChkNotifyAlertProfileSwitch) = $GUI_CHECKED)			
